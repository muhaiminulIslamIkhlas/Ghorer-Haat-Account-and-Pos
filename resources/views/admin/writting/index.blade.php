	 ...
	 <div class="sl-page-title">
        ...
        <div class="card pd-20 pd-sm-40">
        	<div class="row">
        		...
        		<div class="col-md-2"><a href="{{URL('/admin/create/writting')}}" class="btn btn-primary text-white">Set Question</a></div>
        	</div>
        	<br>
        	<br>
            ...
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                  	@if($row->status==1)
                  		<a href="{{URL('/admin/close/writtings/'.$row->id)}}"  class="btn btn-danger btn-icon rounded">
					  <div><i class="fa fa-toggle-off"></i></div>
					</a>
                  	@else
                  		<a href="{{URL('/admin/available/writtings/'.$row->id)}}" class="btn btn-success btn-icon rounded">
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      ...
				      <div class="modal-footer">
				      	<a type="button" href="{{URL('/admin/delete/writtings/'.$row->id)}}" class="btn btn-danger" >Delete</a>
