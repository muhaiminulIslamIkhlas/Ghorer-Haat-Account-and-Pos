...
@section('body')
    ...
    <div class="card pd-20 pd-sm-40">
        <div class="row">
            <div class="col-md-10"><h6 class="card-body-title">Payable List</h6></div>
            <div class="col-md-2"><a href="{{URL('/admin/payment/all')}}" class="btn btn-primary text-white">See All Payment</a></div>
        </div>
        <br>
        <br>
        ...
        <div class="table-wrapper text-black" >
            <table id="datatable1" class="table table-bordered" >
                ...
                <tr>
                    ...
                    <th class="wd-20p">Expenses Type</th>
            ...
            <div class="modal-content">
                ...
                <form id="myForm">
                    <div class="modal-body bg-white">
                        ...
                        @csrf
                        <input type="hidden" id="field" name="payable_id" >
        ...
        <script>
            $(document).ready(function(){
                ...
                $('.modal').on('show.bs.modal', function(e) {
                    ...
                    $(e.currentTarget).find('input[name="payable_id"]').val(userid);
                });

                $('#myForm').on('submit', function(event){
                    event.preventDefault();
                    $.ajax({
                        url:'{{URL('/admin/payment/payable')}}',
                        method:'post',
                        data:$(this).serialize(),
                        dataType:'json',
                        beforeSend:function(){
                        ...
                        success:function(data)
                        {
                            ...
                            else
                            {
                                ...
                                window.setTimeout(function(){window.location.href="{{URL('admin/index/payable')}}";},2000)
