...
$(document).ready(function(){
 ...
 {
  html = '<tr>';
        html += '<td><input type="text" name="customer_name[]" class="form-control" /></td>';
 ...
 $('#dynamic_form').on('submit', function(event){
        ...
        $.ajax({
            url:'{{URL('/admin/save/direct/sell')}}',
            method:'post',
            data:$(this).serialize(),
            dataType:'json',
            beforeSend:function(){
   ...
   function List(){
        ...
        $.ajax({
            url:'{{URL('/admin/list/directSell/delete')}}',
            method:'post',
