...
<div class="row">
   <div class="col-md-6">
    ...
    <div class="bg-secondary text-center text-white p-2"><h4>Office Cost</h4></div>
...
List();
 ...
 {
  html = '<tr>';
        html += '<td><input type="text" name="reason[]" class="form-control" /></td>';
...
function List(){
        ...
        $.ajax({
            url:'{{URL('/admin/list/officeCost/delete')}}',
            method:'post',
