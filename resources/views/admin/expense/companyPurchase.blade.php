...
<div class="row">
  <div class="col-md-6">
    ...
    <div class="bg-secondary text-center text-white p-2"><h4>Company Purchase</h4></div>
...
List();
 ...
 {
  html = '<tr>';
        html += '<td><input type="text" name="company_name[]" class="form-control" /></td>';
 ...
 $('#dynamic_form').on('submit', function(event){
        ...
        $.ajax({
            url:'{{URL('/admin/save/companyPurchase')}}',
            method:'post',
            data:$(this).serialize(),
            dataType:'json',
            beforeSend:function(){
   ...
   function List(){
        console.log('clicked');
        $.ajax({
            url:"{{URL('/admin/list/companyPurchase')}}",
            method:"get",
            success:function(data){
        ...
        $.ajax({
            url:'{{URL('/admin/list/companyPurchase/delete')}}',
            method:'post',
